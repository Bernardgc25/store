...
public class StoreDAO {
    ...
    //retrieve all products via hashamp, key value = category
    ...
    //retrieve all products via hashamp,  key value = productId
    public HashMap<Integer, Product>displayallProducts(){
        ...
        try {
            ...
            while( rs.next() ){
                ...
                p = new Product(ProductId, productName, Category, availQty, buyingPrice, sellingPrice);
    ...
    //retrieve all products via hashamp,  key value = productName
    public HashMap<String, Product>retrievebyPrice(){
        HashMap<String, Product> map_product = new HashMap<>();
        Product p; 
