...
public class StoreDAO {
    ...
    //display total Expenses, hashamp return method 
    public HashMap<Integer, Product>Expenses(){
        HashMap<Integer, Product> map_product = new HashMap<>();
        Product p; 

        try {
            String sql =    "SELECT productName, buyingPrice * availQty AS Expenses FROM Product";
